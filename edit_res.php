...
?>
        ...
        <tr id="<?php
            ...
            echo getWDay(date('N', strtotime($event->revYear . "-" . $event->revMonth . "-" . $event->revDay))); ?>
            </td>
            <td style="text-align: center;" class="lDate"></td>
...
?>
    ...
    <br />
    <a href="<?php
echo 'view.php?db=' . $_SESSION['db'] ?>" target="_blank">Bản
        In</a>
